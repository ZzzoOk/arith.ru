...
const Menu = () => {
    ...
    return (
        <nav id={styles.menu}>
            <ul>
                <li><NavLink end to='/' className={({ isActive }) => isActive ? styles.active : undefined}>
                ...
                <li><NavLink to='/leaderboard' className={({ isActive }) => isActive ? styles.active : undefined}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                        <path d="m 1 10 h 4 v 5 H 1 v -5 z M 6 1 h 4 v 14 H 6 V 1 z m 5 5 h 4 v 9 h -4 V 6 z" />
                    </svg>
                </NavLink></li>
                <li><NavLink to={isAuth ? '/profile' : '/login'} className={({ isActive }) => isActive ? styles.active : undefined}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
